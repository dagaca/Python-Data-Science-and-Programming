...
a = array.reshape(3,5)
print("shape: ",a.shape) # kaça kaçlık matris
print("dimension: ", a.ndim) # kaç boyutlu matris

print("data type: ",a.dtype.name) # dataların tipi
print("size: ",a.size) # matris boyutu
